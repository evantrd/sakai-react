...
case "GET": try {
  ...
  const query = {
    // give the query a unique name
    text: 'UPDATE  iqsoft.product_clasification  SET "Active" = $1,   "Description" = $2, "Code" = $3 ,   "InventoryControl" = $4,   "DateModified" = $5,   "IdUserModified" = $6  WHERE "Id" = $8 and "CompanyId" = $7',
    values : [ Active
      ,Description,
      Code,
      InventoryControl,
...
case "POST":try {
  ...
  const text = 'INSERT INTO iqsoft.product_clasification  ("Active", "IdUserCreated", "DateCreated", "IdUserModified", "DateModified", "Description", "Code", "InventoryControl") VALUES($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *'
  const values = [
    Active
    ,Description,
    Code,
...
const query = {
  // give the query a unique name
  text: 'UPDATE  iqsoft.product_clasification   SET "Active" = false  WHERE "CompanyId" = $1 and  "Id" = $2',
  values : [ 
    CompanyId,Id   
    ],
}
