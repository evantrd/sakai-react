            ...
            <div className="grid">
                <div className="col-12">
                    <div className="card docs">
                        ...
                        <p>
                            Sakai is an application template for React based on the popular <a href="https://nextjs.org/" className="font-medium hover:underline">NextJS</a> framework. To get started, clone the <a href="/" className="font-medium hover:underline">repository</a> from 
